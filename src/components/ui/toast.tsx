...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:flex-col md:max-w-[420px] [padding-bottom:max(env(safe-area-inset-bottom),1rem)] sm:[padding-bottom:max(env(safe-area-inset-bottom),1rem)]",
      className
    )}
    {...props}
  />
